...
> This retrieves the auth token for vivek

curl -X POST -F 'username=vivek' -F 'password=vivek' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=vivek password=vivek


> This will retrieve all items

curl -X GET -H 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6'


> This will retreive a single item

curl -X GET -H 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' http://api:8000/item/a19c8bea-b554-43ab-b17d-f0c3e59bdc8c/

http http://api:8000/item/a19c8bea-b554-43ab-b17d-f0c3e59bdc8c/ 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6'

> This will place an order for item id = a19c8bea-b554-43ab-b17d-f0c3e59bdc8c quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' -d '{"item": "a19c8bea-b554-43ab-b17d-f0c3e59bdc8c", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' item="a19c8bea-b554-43ab-b17d-f0c3e59bdc8c" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/**your_order_uuid**/ 'Authorization: Token dc4283f4c0305d26a4f9d749bd0268e255265fe6'
